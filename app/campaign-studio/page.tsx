...
export default function CampaignStudio(){
 ...
 <div style={{padding:22}}><p style={{color:tones[p.brand],fontSize:12,letterSpacing:1.4}}>{p.brand.toUpperCase()} · {p.channel}</p><h3 style={{fontSize:24,lineHeight:1.25}}>{p.hook}</h3><p style={{whiteSpace:"pre-wrap",lineHeight:1.6,color:"#d0dae6"}}>{p.caption}</p><p style={{fontWeight:700,color:tones[p.brand]}}>CTA: {p.cta}</p><p style={{fontSize:13,color:"#f2d8a2"}}>Draft · Not yet published</p></div></article>)}</div></section>
 </main>
}