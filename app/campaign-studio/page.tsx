...
export default function CampaignStudio(){
 ...
 {(assets[p.postId]||avatars[p.brand]||(p.brand==="Bankole & Associates"?founder:null))&&<img src={assets[p.postId]||avatars[p.brand]||founder} alt={p.brand+" campaign imagery"} style={{width:"100%",height:320,objectFit:"cover",objectPosition:"center 27%"}}/>}
